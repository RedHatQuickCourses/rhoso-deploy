...
* Deploy Controlplane services on the RHOCP cluster.
* Verify functionality of Controlplane services.
* Deploy Dataplane node using RHOCP cluster.
* Verify functionality of Dataplane deployment.
